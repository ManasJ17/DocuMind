...
export default function RegisterPage() {
    ...
    const inputClass = "w-full h-10 px-3 pr-10 rounded-xl border border-gray-200 dark:border-gray-700 bg-[#F9FAFB] dark:bg-gray-800 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none text-sm";
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                        ...
                        {error && (
                            <div className="p-3 rounded-xl bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 text-red-600 dark:text-red-400 text-xs text-center">
                                ...
                                {error.includes('already registered') && (
                                    <Link to="/login" className="block mt-1 text-blue-600 dark:text-blue-400 font-medium hover:underline">
                                        Go to Login →
                                    </Link>
                                )}
                            </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6} className={inputClass} placeholder="••••••••" />
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input type={showConfirm ? 'text' : 'password'} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required className={inputClass} placeholder="••••••••" />
